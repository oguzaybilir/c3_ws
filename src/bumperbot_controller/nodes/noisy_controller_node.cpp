...
#include "bumperbot_controller/noisy_controller.h" // SimpleController sınıfımızın header dosyasını import ediyoruz


int main(int argc, char **argv) // main fonksiyonumuzu oluşturuyoruz
{
    ros::init(argc, argv, "noisy_controller"); // ros node'u başlatıyoruz
